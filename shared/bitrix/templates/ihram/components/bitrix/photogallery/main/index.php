...
if ($arParams["PERMISSION"] >= "U" || $arParams["SHOW_TAGS"] == "Y" || !empty($arRes))
{
	...
	{
	?>
	<div class="photo-controls photo-controls-buttons text-right">
		<ul class="photo-controls list-inline">
			<li class="photo-control photo-control-first photo-control-album-add">
				<a class="btn btn-success" rel="nofollow" href="<?=CComponentEngine::MakePathFromTemplate($arParams["SECTION_EDIT_URL"],
			...
			<li class="photo-control photo-control-last photo-control-album-upload">
				<a class="btn btn-warning" rel="nofollow" href="<?=CComponentEngine::MakePathFromTemplate($arParams["UPLOAD_URL"], array("SECTION_ID" => "0"))?>">
